...
const cpuFile=process.argv[2]||'cpu.js';
...
let dmaStarts=0; const od=mmu.doPiDma.bind(mmu); mmu.doPiDma=function(x){dmaStarts++;return od(x);};
const N=parseInt(process.argv[3]||'30000000');
for(let s=0;s<N;s++)cpu.step();
console.log(cpuFile,'-> f3dTaskCount=',rcp.f3dTaskCount|0,'PIdmaStarts=',dmaStarts);

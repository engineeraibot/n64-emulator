...
// Force-disable texturing — always sample as white
...
console.log('[notex] f3d:', rcp.f3dTaskCount, 'tri:', rcp.drawStats.triangles, 'offscreen:', rcp.drawStats.offscreenTriangles||0);
...
for(const fb of [0x38f800, 0x3b5000, 0x3da800]) {
    console.log(`[notex] FB 0x${fb.toString(16)}: ${countNB(fb)} non-black`);
    dumpFB(fb, path.join(ROOT, 'test-results', `sm64-notex-${fb.toString(16)}.png`));
}

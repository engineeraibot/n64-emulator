...
rcp._noSwz = process.env.NOSWZ==='1';
const realLog=console.log.bind(console);
rcp.f3dTaskCount=0;const t0=Date.now();
for(let s=0;;s++){ try{cpu.step();}catch(e){break;} if((s&0x1FFFF)===0){ if((rcp.f3dTaskCount|0)>=3)break; if(Date.now()-t0>40000)break; } }
const snap=rcp.bestRichVideoSnapshot;realLog('nonBlack='+snap.nonBlack);

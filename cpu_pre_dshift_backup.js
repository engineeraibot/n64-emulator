class CPU {
    ...
    opCOP1(i, pc, ds) {
        ...
        else if (sub === 0x01) this.gpr[rt] = this.fprView.getInt32(fs * 8 + 4, false); // DMFC1: lower 32 bits of 64-bit FPR
    ...
    opCOP0(i, pc, ds) {
        ...
        if (sub === 0x00) this.gpr[rt] = this.cp0Registers[rd] | 0;
        else if (sub === 0x01) this.gpr[rt] = this.cp0Registers[rd] | 0;
        else if (sub === 0x04) {

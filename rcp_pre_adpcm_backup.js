        ...
        for (let off = 0; off + 8 <= dataSize && (cmdBase + off + 8) <= lim; off += 8) {
            ...
            switch (op) {
                ...
                case 0x07: // A_SEGMENT
                    ...
                    break;
                case 0x08: // A_SETBUFF: in=w0[15:0], out=w1[31:16], count=w1[15:0]
                ...
                case 0x0F: // A_SETLOOP
                    ...
                    break;
                // Note-synthesis ops below are implemented best-effort; the SM64 title
                // screen never emits them (verified), so they are not exercised/validated
                // yet. ADPCM/ENVMIXER decode is left as a documented TODO (no-op) rather
                // than shipping unverified DSP that could corrupt in-game mixes.
                case 0x01: // A_ADPCM (TODO: order-2 ADPCM decode)
                case 0x03: // A_ENVMIXER (TODO: volume-envelope mixer)
                case 0x09: // A_SETVOL
                case 0x0E: // A_POLEF
                default:
                    break;

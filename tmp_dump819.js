...
function dis(w,va){const op=w>>>26,rs=(w>>21)&31,rt=(w>>16)&31,rd2=(w>>11)&31,sa=(w>>6)&31,fn=w&63,imm=(w<<16>>16);
 if(w===0)return 'nop';
 if(op===0){const m={0x08:'jr',0x09:'jalr',0x21:'addu',0x23:'subu',0x25:'or',0x24:'and',0x02:'srl',0x03:'sra',0x2a:'slt',0x2b:'sltu',0x10:'mfhi',0x12:'mflo',0x0c:'syscall',0x00:'sll'};
 ...
 if(op===0x10)return 'cop0 rs=0x'+rs.toString(16)+' rt='+R[rt]+' rd='+rd2;
 if(op===0x11)return 'cop1 rs=0x'+rs.toString(16)+' '+R[rt];
 ...
 const m={0x23:'lw',0x24:'lbu',0x20:'lb',0x25:'lhu',0x21:'lh',0x2b:'sw',0x28:'sb',0x29:'sh',0x0f:'lui',0x0d:'ori',0x09:'addiu',0x0c:'andi',0x0a:'slti',0x0b:'sltiu',0x37:'ld',0x3f:'sd'};
...
const base=parseInt(process.env.ADDR||'0x8019ab30',16);
for(let va=base;va<base+0x60;va+=4){const w=rd.getUint32(va&0x7FFFFF,false)>>>0;console.log('0x'+va.toString(16),('0000000'+w.toString(16)).slice(-8),dis(w,va));}

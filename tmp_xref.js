...
const hits=[];
for(let a=0x100000;a<0x300000;a+=4){const w=dv.getUint32(a,false)>>>0;
  if((w>>>26)===0x09 && (w&0xffff)===0x5388){hits.push(a);}
}
console.log('addiu ...,0x5388 sites:',hits.map(h=>'0x'+(0x80000000+h>>>0).toString(16)));

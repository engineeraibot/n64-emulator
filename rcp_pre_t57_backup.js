...
class RCP {
    ...
    handleG_FILLRECT(hi, lo) {
        ...
        // fade-in did exactly this -> permanently black frames). Treat cycle-mode
        // fill rects as overlays we don't composite yet (skip) rather than a
        // destructive clear. SM64/MK64 clear in FILL mode, so they're unaffected.
        const _cyc = (this.rspState.otherModeHi >>> 20) & 3;
        if (_cyc === 0 || _cyc === 1) return;

...
function dis(w){const op=w>>>26,rs=(w>>21)&31,rt=(w>>16)&31,rd=(w>>11)&31,fn=w&63,imm=(w<<16>>16);
 if(w===0)return 'nop';
 if(op===0){const m={0x08:'jr',0x09:'jalr',0x21:'addu',0x25:'or',0x24:'and',0x00:'sll',0x2a:'slt',0x2b:'sltu'};return (m[fn]||('spec fn=0x'+fn.toString(16)))+' '+R[rd]+','+R[rs]+','+R[rt];}
 ...
 const m={0x23:'lw',0x24:'lbu',0x20:'lb',0x2b:'sw',0x28:'sb',0x0f:'lui',0x0d:'ori',0x09:'addiu',0x0c:'andi'};
...
for(const base of [0x80269290,0x80244230]){
 console.log('=== around 0x'+base.toString(16)+' ===');
 for(let va=base;va<base+0x50;va+=4){const w=ram.read32(va&0x7FFFFF)>>>0;const mark=(va===0x802692c8||va===0x8024425c)?'  <== resume':'';console.log('  0x'+va.toString(16),dis(w)+mark);}
}

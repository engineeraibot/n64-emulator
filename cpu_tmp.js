class CPU {
    ...
    tryFastForwardIdleLoop(status, cause) {
        ...
        const compare = Number(this.cp0Registers[11] & 0xFFFFFFFFn);
        if (compare !== 0) {
            const count = Number(this.cp0Registers[9] & 0xFFFFFFFFn);
        ...
        if (skipped > 0) {
            ...
            if (countInc > 0) {
                this.cp0Registers[9] = (this.cp0Registers[9] + BigInt(countInc)) & 0xFFFFFFFFn;
            }
        }
